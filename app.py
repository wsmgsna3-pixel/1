...
last_trade_day = "20250917"  # 90天内真实交易日
yesterday = "20250916"
start_date = "20250601"
...
if st.button("开始选股", type="primary"):
    st.caption(f"数据：{last_trade_day[:4]}-{last_trade_day[4:6]}-{last_trade_day[6:]} | 昨日：{yesterday[:4]}-{yesterday[4:6]}-{yesterday[6:]}")
